...
$s_tpages
  ...
  <button class="btn waves-effect waves-light" type="submit" class="waves-effect waves-light" name="template" accesskey="r">$_btn_load</button>
  <br>
EOD;
	...
	if ($notimeupdate != 0) {
		...
		$add_notimestamp = '' . "\n" .
			'   ' . '<label><input type="checkbox" name="notimestamp" ' .
			'id="_edit_form_notimestamp" value="true"' . $checked_time . '><span class="small">' .
...
$template
  ...
  <textarea name="msg" rows="$rows" cols="$cols" style="height: 20rem;resize: none;">$s_postdata</textarea>
  <br>
  <div style="float:left;">
	<button class="btn waves-effect waves-light" type="submit" name="preview" accesskey="p">$btn_preview</button>
	<button class="btn waves-effect waves-light" type="submit" name="write" accesskey="s">$_btn_update</button>
   $add_top
   $add_notimestamp
  </div>
 ...
 <form action="$script" method="post" class="_plugin_edit_cancel" style="margin-top:0;">
  <input type="hidden" name="cmd"    value="edit">
  <input type="hidden" name="page"   value="$s_page">
  <button class="btn waves-effect waves-light" type="submit" name="cancel" accesskey="c">$_btn_cancel</button>
 </form>
</div>
EOD;
...
function make_related($page, $tag = '')
{
	...
	foreach ($links as $page=>$lastmod) {
		...
		if ($tag) {
			...
			$_links[] = '<li><a class="grey-text text-lighten-4" href="' . $page_uri . '">' .
			$s_page . '</a></li>';
		}
	}
