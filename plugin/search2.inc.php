	...
	$offset, $prev_offset_s = null)
{
 ...
 <div>
  <label>
   <input type="radio" name="base" value="$s_base" $check> <span>$base_label</span>
  </label>
 </div>
EOD;
			$check = '';
...
<label><input type="checkbox" id="_plugin_search2_detail" checked><span>$_search_detail</span></label>
