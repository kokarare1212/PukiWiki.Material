...
<form action="$script" method="post">
 <div>
  ...
  <button class="btn waves-effect waves-light" type="submit">{$_rename_messages['btn_next']}</button><br>
 </div>
</form>
EOD;
	return $ret;
...
<form action="$script" method="post">
 <div>
  ...
  <button class="btn waves-effect waves-light" type="submit">{$_rename_messages['btn_submit']}</button>
 </div>
</form>
