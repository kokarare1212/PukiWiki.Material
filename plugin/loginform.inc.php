...
<?php endif ?>
  <tr>
    <td></td>
    <td class="login-button-container"><button class="btn waves-effect waves-light" type="submit" class="loginbutton"><?php echo htmlsc($_loginform_messages['login']) ?></button></td>
  </tr>
  </tbody>
</table>
</div>
