...
<form enctype="multipart/form-data" action="$script" method="post">
 <div>
  ...
  $pass
  <button class="btn waves-effect waves-light" type="submit">{$_attach_messages['btn_upload']}</button>
 </div>
</form>
EOD;
}
...
<form action="$script" method="post">
 <div>
  ...
  <button class="btn waves-effect waves-light" type="submit">{$_attach_messages['btn_submit']}</button>
 </div>
</form>
EOD;
		return $retval;
