...
EOD;
  ...
  <label><input type="radio" name="scheme" id="_p_md5_md5"  value="x-php-md5"><span>PHP md5</span></label><br>
EOD;
	if ($algos_enabled->sha1) $form .= <<<EOD
  
  <label><input type="radio" name="scheme" id="_p_md5_sha1" value="x-php-sha1"><span>PHP sha1</span></label><br>
EOD;
	if ($algos_enabled->sha256) $form .= <<<EOD
  
  <label><input type="radio" name="scheme" id="_p_md5_sha256" value="x-php-sha256"><span>PHP sha256</span></label><br>
EOD;
	if ($algos_enabled->sha512) $form .= <<<EOD
  
  <label><input type="radio" name="scheme" id="_p_md5_sha512" value="x-php-sha512"><span>PHP sha512</span></label><br>
EOD;
	if ($algos_enabled->sha1) $form .= <<<EOD
  
  <label><input type="radio" name="scheme" id="_p_md5_lssha" value="SSHA" $sha1_checked/><span>LDAP SSHA (sha-1 with a seed) *</span></label><br>
  
  <label><input type="radio" name="scheme" id="_p_md5_lsha" value="SHA"><span>LDAP SHA (sha-1)</span></label><br>
EOD;
	$form .= <<<EOD
  
  <label><input type="radio" name="scheme" id="_p_md5_lsmd5" value="SMD5" $md5_checked/><span>LDAP SMD5 (md5 with a seed) *</span></label><br>
  
  <label><input type="radio" name="scheme" id="_p_md5_lmd5" value="MD5"><span>LDAP MD5</span></label><br>
EOD;
	if ($algos_enabled->sha256) $form .= <<<EOD
  
  <label><input type="radio" name="scheme" id="_p_md5_lssha256" value="SSHA256"/><span>LDAP SSHA256 (sha256 with a seed) *</span></label><br>
  
  <label><input type="radio" name="scheme" id="_p_md5_lsha256" value="SHA256"><span>LDAP SHA256</span></label><br>
EOD;
	if ($algos_enabled->sha512) $form .= <<<EOD
  
  <label><input type="radio" name="scheme" id="_p_md5_lssha512" value="SSHA512"/><span>LDAP SSHA512 (sha512 with a seed) *</span></label><br>
  
  <label><input type="radio" name="scheme" id="_p_md5_lsha512" value="SHA512"><span>LDAP SHA512</span></label><br>
EOD;
	$form .= <<<EOD
  ...
  <button class="btn waves-effect waves-light" type="submit">Compute</button><br>
